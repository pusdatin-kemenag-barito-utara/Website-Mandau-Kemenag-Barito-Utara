import { Inbox, Sparkles, ShieldCheck, FileInput } from "lucide-react";
import { MasterSectionCard } from "./master-section-card";

export function OpsiSuratMasukView() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      {/* Kolom Kiri: Kartu Kelola Agenda Surat Masuk */}
      <div className="lg:col-span-7">
        <MasterSectionCard
          kategori="agenda_masuk"
          title="Jenis Agenda Surat Masuk"
          subtitle="Klasifikasi naskah masuk pada buku register dan formulir pencatatan"
          icon={Inbox}
          accent="emerald"
          badgeLabel="Naskah Masuk"
          infoNote="Setiap opsi agenda di atas langsung aktif dan dapat dipilih staf saat mencatat surat masuk baru."
        />
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-900 dark:text-white">
                Integrasi Operasional Surat Masuk
              </h4>
              <p className="text-[11px] text-slate-400">
                Penerapan opsi agenda pada alur naskah dinas masuk
              </p>
            </div>
          </div>

          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
            Opsi <strong>Jenis Agenda</strong> digunakan untuk mengelompokkan surat yang diterima dari pihak eksternal (Kanwil, Pemda, Madrasah, KUA, dll.).
          </p>
          ...
          <div className="space-y-2.5 pt-1">
            <div className="flex items-start gap-2.5 p-3 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5">
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-snug">
                <strong>Formulir Registrasi:</strong> Pilihan agenda otomatis tersedia pada dropdown input surat masuk di menu Surat Masuk.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2.5 p-3 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5">
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-snug">
                <strong>Lembar Disposisi:</strong> Klasifikasi agenda dicetak pada lembar disposisi resmi untuk arahan pimpinan.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2.5 p-3 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5">
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-snug">
                <strong>Buku Register & Rekap:</strong> Memudahkan penyaringan saat ekspor agenda tahunan ke format Excel & PDF.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-5 bg-gradient-to-br from-emerald-900/[0.03] to-slate-50 dark:from-emerald-950/20 dark:to-transparent border border-emerald-500/20 rounded-3xl shadow-sm space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-700 dark:text-emerald-400">
              Contoh Tampilan Pada Surat Masuk
            </span>
