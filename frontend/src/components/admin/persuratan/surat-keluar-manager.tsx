...
export function SuratKeluarManager({
  ...
  const handleCopySummary = (item: SuratKeluar) => {
    const text =
      `📋 *DETAIL NASKAH DINAS KELUAR — SI MANDAU*\n` +
      `━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
      `📌 *No. Agenda*: ${item.id || '-'}\n` +
      `📄 *No. Surat*: ${item.nomor_surat}\n` +
      `📅 *Tgl. Terbit*: ${formatDate(item.tanggal_surat)}\n` +
      `🏢 *Unit Kerja Pengirim*: ${item.unit_kerja}\n` +
      `🎯 *Tujuan / Penerima*: ${item.tujuan_surat}\n` +
    ...
    <FramerProvider>
      ...
      <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div className="relative flex-1 min-w-[280px]">
          ...
          <input
            id="search_surat_keluar"
            name="search_surat_keluar"
            type="text"
      ...
      {!loading && !fetchError && (
        <div ref={tableRef} className="bg-white dark:bg-[#1a1d24] border border-slate-200/80 dark:border-white/10 rounded-3xl shadow-sm overflow-hidden scroll-mt-20">
          <div className="overflow-x-auto custom-scrollbar">
            <table className="w-full min-w-[950px] text-sm border-collapse">
              <thead>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-5 border-b border-slate-100 dark:border-white/5 bg-slate-50/70 dark:bg-white/[0.02] shrink-0">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-xl sm:rounded-2xl bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400 flex items-center justify-center border border-violet-100 dark:border-violet-500/20 shadow-xs shrink-0">
                    <FileOutput className="h-4.5 w-4.5 sm:h-5 sm:w-5" />
                  </div>
                  <div>
              ...
              <div className="p-4 sm:p-8 space-y-4 sm:space-y-5 flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider block ml-1">
                      Jenis Agenda <span className="text-rose-500">*</span>
                    </label>
                    <ModernSelect
                      name="agenda"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider block ml-1">
                      Unit Kerja Pengirim <span className="text-rose-500">*</span>
                    </label>
                    <ModernSelect
                      name="unit_kerja"
                ...
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider block ml-1">
                    Tujuan Surat / Penerima <span className="text-rose-500">*</span>
                  </label>
                  <input
                    id="tujuan_surat_keluar"
                    name="tujuan_surat"
                    required
                    type="text"
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                      <div className="h-8.5 w-8.5 sm:h-9 sm:w-9 rounded-xl bg-violet-100 dark:bg-violet-500/20 text-violet-600 dark:text-violet-400 flex items-center justify-center shrink-0">
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4.5 border-b border-slate-100 dark:border-white/5 bg-slate-50/60 dark:bg-white/[0.02]">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="h-9 w-9 rounded-xl bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400 flex items-center justify-center border border-violet-100 dark:border-violet-500/20 shrink-0">
                  ...
                  <div className="space-y-1 min-w-0 flex-1">
                    <div className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500">
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-slate-200/60 dark:hover:bg-white/10 rounded text-slate-400 hover:text-violet-600 transition-all"
                    ...
                    <p className="font-mono text-sm sm:text-base font-black text-violet-700 dark:text-violet-400 break-all select-all">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        onClick={() => {
                          ...
                          setPdfViewerTitle(`Lampiran Surat Keluar - ${detailItem.nomor_surat}`);
                        }}
                        className="px-3 py-1.5 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-xs font-bold shadow-sm transition-all inline-flex items-center gap-1"
                      >
